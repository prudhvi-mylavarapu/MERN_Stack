...
const PostCard = () => {
  ...
  const getTwoSentences = (text) => {
    ...
    return (
        <>
            {posts.map((post) => (
                <div key={post.id} className='flex flex-col sm:flex-row gap-3 sm:gap-5 border-b border-gray-200 p-3 sm:p-5'>
                    ...
                    <div className='flex flex-col gap-2 sm:gap-2.5 w-full sm:w-5/6'>
                        <div className='flex flex-col sm:flex-row gap-2 sm:gap-0'>
                            ...
                            <span className='sm:ml-auto border-none rounded-xl px-3 py-1 bg-green-300 text-green-800 text-xs sm:text-sm w-fit'>Published</span>
                        </div>
                    ...
                    <div className='flex items-start gap-3 sm:gap-5 mx-0 sm:mx-2'>
                        <img className='w-5 sm:w-6 cursor-pointer border-none hover:bg-green-200 rounded' src={eye} alt="eye" />
                        <img className='w-5 sm:w-6 cursor-pointer border-none hover:bg-blue-200 rounded' src={pencil} alt="edit" />
                        <img className='w-5 sm:w-6 cursor-pointer border-none hover:bg-red-200 rounded' src={trash} alt="delete" />
                    </div>
                </div>
            ))}
        </>
